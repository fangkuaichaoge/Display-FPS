...
static void DrawMenu() {
    ...
    ImGui::Text("FPS");
    snprintf(buf, sizeof(buf), "%.1f", g_SmoothedData.fps);
    ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
    ...
    ImVec4 cpsColor = g_SmoothedData.cps >= 10.0f ? ImVec4(0.22f, 0.82f, 0.46f, 1.0f)
                       ...
                       : ImVec4(0.95f, 0.22f, 0.22f, 1.0f);
    ImGui::Text("CPS");
    snprintf(buf, sizeof(buf), "%.1f", g_SmoothedData.cps);
    ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
    ImGui::TextColored(cpsColor, "%s", buf);
    ...
    ImVec4 cpuColor = g_SmoothedData.cpuUsage < 50.0f ? ImVec4(0.22f, 0.82f, 0.46f, 1.0f)
                       ...
                       : ImVec4(0.95f, 0.22f, 0.22f, 1.0f);
    ImGui::Text("CPU");
    snprintf(buf, sizeof(buf), "%.1f%%", g_SmoothedData.cpuUsage);
    ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
    ImGui::TextColored(cpuColor, "%s", buf);
    ...
    ImVec4 latencyColor = g_SmoothedData.latency < 20.0f ? ImVec4(0.22f, 0.82f, 0.46f, 1.0f)
                       ...
                       : ImVec4(0.95f, 0.22f, 0.22f, 1.0f);
    ImGui::Text("Latency");
    snprintf(buf, sizeof(buf), "%.1f ms", g_SmoothedData.latency);
    ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
    ImGui::TextColored(latencyColor, "%s", buf);
    ...
    ImVec4 memColor = g_SmoothedData.memoryUsage < 200.0f ? ImVec4(0.22f, 0.82f, 0.46f, 1.0f)
                       ...
                       : ImVec4(0.95f, 0.22f, 0.22f, 1.0f);
    ImGui::Text("Memory");
    snprintf(buf, sizeof(buf), "%.1f MB", g_SmoothedData.memoryUsage);
    ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
    ImGui::TextColored(memColor, "%s", buf);
    ...
    if (g_ShowDetails) {
        ...
        snprintf(buf, sizeof(buf), "%.2f ms", g_SmoothedData.frameTime);
        ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
        ImGui::Text("%s", buf);

        // Resolution
        ImGui::Text("Resolution");
        snprintf(buf, sizeof(buf), "%dx%d", g_Width, g_Height);
        ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(buf).x - 12);
        ImGui::Text("%s", buf);

        // Render API
        ImGui::Text("Render API");
        const char* apiStr = "OpenGL ES 3.0";
        ImGui::SameLine(ImGui::GetWindowWidth() - ImGui::CalcTextSize(apiStr).x - 12);
        ImGui::Text("%s", apiStr);
    }
